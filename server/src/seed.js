...
const users = [
  { id: 'u1', name: '旅行的猫', avatar: avatar(11), desc: '世界那么大，我想去看看 🌍', fans: 12800, follows: 231, likes: 98000, vip: false },
  { id: 'u2', name: '美食研究所', avatar: avatar(12), desc: '一个爱做饭的程序员', fans: 45600, follows: 88, likes: 320000, vip: true },
  { id: 'u3', name: '穿搭日记', avatar: avatar(5), desc: '记录每天的小确幸', fans: 8900, follows: 412, likes: 56000, vip: false },
  { id: 'u4', name: '金融小课堂', avatar: avatar(15), desc: '只讲干货', fans: 23400, follows: 56, likes: 145000, vip: true },
  { id: 'u5', name: '家居灵感', avatar: avatar(20), desc: '把日子过成诗', fans: 67200, follows: 120, likes: 480000, vip: false },
  { id: 'u6', name: '数码控小李', avatar: avatar(33), desc: '只聊真实体验', fans: 34500, follows: 67, likes: 210000, vip: false },
];
...
const notes = [
  ...
  note({ id: 'n3', authorId: 'u4', category: '金手指', type: 'course', courseUrl: 'https://pan.baidu.com/s/1AbCdEfG 提取码: jz88', title: '【金手指】缠论买卖点系统课', ratio: 1.15, images: ['gold1', 'gold2'], content: '完整视频 + 源码，点击获取课程……', tags: ['金手指', '课程'], likes: 8900, collects: 5600, comments: 0, hours: 4 }),
  ...
  note({ id: 'n7', authorId: 'u4', category: '金手指', type: 'course', courseUrl: 'https://pan.baidu.com/s/1HjKlMn 提取码: js66', title: '【金手指】波段操作系统资料包', ratio: 1.4, images: ['gold3'], content: '波段心法 + 选股公式……', tags: ['金手指'], likes: 45600, collects: 28000, comments: 0, hours: 26 }),
...
const categories = ['指标', '视频', '金手指'];
const hotSearch = ['缠论', 'MACD', '均线', '波段', '复盘', '金手指', '资金流向', '选股公式'];
const admins = [{ username: 'admin', password: 'admin123' }];

module.exports = function seed() {
  return { users, notes, categories, hotSearch, admins };
};
