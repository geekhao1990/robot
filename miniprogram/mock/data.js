...
const rawNotes = [
  {
    ...
    tags: ['大理', '洱海', '旅行攻略'], likes: 58, collects: 26, time: 1, video: false,
  },
  {
    ...
    tags: ['快手早餐', '减脂餐', '美食'], likes: 43, collects: 31, time: 3, video: false,
  },
  {
  ...
  },
  {
    ...
    tags: ['健身', '马甲线', '居家运动'], likes: 67, collects: 38, time: 8, video: true,
  },
  {
    ...
    tags: ['出租屋改造', '家居', '租房'], likes: 52, collects: 29, time: 12, video: false,
  },
  {
    ...
    tags: ['数码', '耳机', '好物推荐'], likes: 34, collects: 22, time: 20, video: false,
  },
  {
    ...
    tags: ['京都', '日本旅行', '小众景点'], likes: 76, collects: 47, time: 26, video: false,
  },
  {
    ...
    tags: ['烘焙', '芝士蛋糕', '甜品'], likes: 61, collects: 42, time: 30, video: false,
  },
  {
    ...
    tags: ['小个子穿搭', '显高', 'OOTD'], likes: 49, collects: 35, time: 40, video: false,
  },
  {
    ...
    tags: ['厨房收纳', '收纳', '家居'], likes: 45, collects: 33, time: 48, video: false,
  },
  {
    ...
    tags: ['跑步', '减肥', '健身'], likes: 54, collects: 37, time: 60, video: false,
  },
  {
    ...
    tags: ['桌搭', '数码', '居家办公'], likes: 63, collects: 41, time: 72, video: false,
  },
  {
    ...
    tags: ['建站', '编程教程', '干货'], likes: 38, collects: 24, time: 4, video: false,
  },
];
